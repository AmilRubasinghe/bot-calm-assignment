...
import { displayText } from '../serverActions/serverAction'
...
export default function Home() {
  ...
  // // return "Do Server Console Log - console.log('This is server action printed on server console')"
  // };
  ...
  return (
    <div className="grid place-items-center mt-10">
      <button onClick={() => displayText("This is server action printed on server console")} className="bg-[white] text-black p-5">Do Server Action </button>
      {/* {isShow && <div className="bg-[white] mt-5 text-black p-5"></div>} */}
